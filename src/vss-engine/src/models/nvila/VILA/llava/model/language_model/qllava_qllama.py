...
from .qllama import QLlamaForCausalLM
...
class QLlavaLlamaModel(LlavaLlamaModel):
    ...
    def init_vlm(self, config: PreTrainedModel = None, model_args=None, *args, **kwargs):
        ...
        args_to_model_class = {
            "qlinear": "QLlamaForCausalLM",
            "te_qlinear": "QLlamaForCausalLM",
            "qmem": "QMemLlamaForCausalLM",
        }
        kwargs.update(
            {"quantize_model_class": args_to_model_class[model_args.quantize_model], "model_args": model_args}
        )
